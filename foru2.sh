#!/usr/bin/bash
 ...
 sed 's+THBD+'$user'+g' edit888/bash2.bashrc > /data/data/com.termux/files/usr/etc/bash2.bashrc
 sed 's+THBD+'$user'+g' edit888/wlc2.py > /data/data/com.termux/files/usr/etc/wlc2.py
 rm -rf edit888
